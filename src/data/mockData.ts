...
export const mockExpenseChangeLogs: ExpenseChangeLog[] = [
  { id: 'ecl1', category: '场地', changeType: 'add', sourceModule: '场地签约', description: '新增签约入账：花园酒店宴会厅', oldAmount: 0, newAmount: 48000, difference: 48000, operator: '系统同步', timestamp: Date.now() - 86400000 * 10 },
  { id: 'ecl2', category: '摄影', changeType: 'add', sourceModule: '摄影签约', description: '新增签约入账：光影纪摄影工作室', oldAmount: 0, newAmount: 12800, difference: 12800, operator: '系统同步', timestamp: Date.now() - 86400000 * 10 },
  { id: 'ecl3', category: '婚纱', changeType: 'add', sourceModule: '婚纱签约', description: '新增签约入账：维多利亚女王+简约优雅+东方佳人', oldAmount: 0, newAmount: 16800, difference: 16800, operator: '系统同步', timestamp: Date.now() - 86400000 * 10 },
  ...
  { id: 'ecl6', category: '婚纱', changeType: 'sync', sourceModule: '婚纱签约', description: '签约金额同步：维多利亚女王+简约优雅+东方佳人', oldAmount: 16800, newAmount: 16800, difference: 0, operator: '系统同步', timestamp: Date.now() - 86400000 * 1 }
]
