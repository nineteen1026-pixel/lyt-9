...
export const mockExpenseChangeLogs: ExpenseChangeLog[] = [
  { id: 'ecl1', category: '场地', changeType: 'sync', sourceModule: '场地选型', description: '同步选型金额：花园酒店宴会厅已签约', oldAmount: 0, newAmount: 48000, difference: 48000, operator: '系统同步', timestamp: Date.now() - 86400000 * 10 },
  { id: 'ecl2', category: '摄影', changeType: 'sync', sourceModule: '摄影选型', description: '同步选型金额：光影纪摄影工作室已签约', oldAmount: 0, newAmount: 12800, difference: 12800, operator: '系统同步', timestamp: Date.now() - 86400000 * 10 },
  { id: 'ecl3', category: '婚纱', changeType: 'sync', sourceModule: '婚纱选型', description: '同步选型金额：维多利亚女王+简约优雅+东方佳人已签约', oldAmount: 0, newAmount: 16800, difference: 16800, operator: '系统同步', timestamp: Date.now() - 86400000 * 10 },
  ...
  { id: 'ecl6', category: '婚纱', changeType: 'sync', sourceModule: '婚纱选型', description: '重新同步婚纱选型金额', oldAmount: 16800, newAmount: 16800, difference: 0, operator: '系统同步', timestamp: Date.now() - 86400000 * 1 }
]
